...
public class WindowIconLoader_old {
    ...
    private static boolean isIconDirectoryExists() {
        try (InputStream inputStream = WindowIconLoader_old.class.getClassLoader().getResourceAsStream(ASSET_ICON_DIR)) {
    ...
    private static InputStream getIconAsInputStream(String assetPath) {
        return WindowIconLoader_old.class.getClassLoader().getResourceAsStream(assetPath);
    }
